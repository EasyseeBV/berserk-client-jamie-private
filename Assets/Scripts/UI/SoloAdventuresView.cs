...
namespace UI
{
	public class SoloAdventuresView : BaseView
	{
		...
		private void CreateChampionButton(Transform parent, string objectName, string title, string subtitle, string botDeckId)
		{
			...
			var portraitFrameGo = new GameObject("PortraitFrame", typeof(RectTransform), typeof(CanvasRenderer), typeof(Image));
			...
			var portraitFrameImage = portraitFrameGo.GetComponent<Image>();
