...
namespace RR.Core.Editor.Extensions
{
    ...
    {
        public static void Add(this SerializedProperty prop, Object value)
        {
            prop.arraySize++;
        ...
        public static void SetObjectValueAt(this SerializedProperty prop, int i, object toValue)
        {
            prop.GetAt(i).SetObjectValue(toValue);
        }

        public static void SetObjectValue(this SerializedProperty prop, object toValue)
        {
            switch (prop.propertyType)
            {
                ...
                case SerializedPropertyType.ObjectReference:
                    prop.objectReferenceValue = toValue as Object;
                    break;
