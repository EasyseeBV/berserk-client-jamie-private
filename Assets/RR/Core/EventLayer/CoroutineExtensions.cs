...
namespace RR.Core.EventLayer
{
    ...
    public static class CoroutineExtensions
    {
        ...
        /// </summary>
        public static IEnumerator Wait(this RREvent e, Func<bool> condition = null)
        {
            var invoked = false;
        ...
        /// yield waiter;
        /// </summary>
        public static Waiter GetWaiter(this RREvent e, Func<bool> condition = null)
        {
        ...
        /// </summary>
        public static Waiter<T> GetWaiter<T>(this RREvent<T> e, Func<T, bool> condition = null)
        {
        ...
        /// </summary>
        public static Waiter<T1, T2> GetWaiter<T1, T2>(this RREvent<T1, T2> e, Func<T1, T2, bool> condition = null)
        {
    ...
    public class Waiter : IWaiter
    {
        ...
        public Waiter(RREvent e, Func<bool> condition = null)
        {
            e.SubscribeRaw(() =>
            {
                Invoked = true;
    ...
    public class Waiter<T> : IWaiter
    {
        ...
        public Waiter(RREvent<T> e, Func<T, bool> condition = null)
        {
            e.SubscribeRaw((data) =>
            {
                Invoked = true;
    ...
    public class Waiter<T1, T2> : IWaiter
    {
        ...
        public Waiter(RREvent<T1, T2> e, Func<T1, T2, bool> condition = null)
        {
