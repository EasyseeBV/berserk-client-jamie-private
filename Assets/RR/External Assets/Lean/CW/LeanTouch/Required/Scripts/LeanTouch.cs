...
namespace Lean.Touch
{
	...
	public partial class LeanTouch : MonoBehaviour
	{
		...
		/// <summary>
		/// Mouse button indices to track as a finger.
		/// For instance, if you don't want mouse right click to trigger a touch, just exclude `1` from the list.
		/// </summary>
		public int[] MouseButtons => mouseButtons; [SerializeField] private int[] mouseButtons = { 0, 1, 2, 3, 4 };
...
namespace Lean.Touch.Editor
{
	...
	public class LeanTouch_Editor : CwEditor
	{
		...
		private void DrawSettings(LeanTouch touch)
		{
			...
			if (touch.UseMouse)
				Draw("mouseButtons", "Mouse button indices to track as a finger. For instance, if you don't want mouse right click to trigger a touch, just exclude `1` from the list.");
