...
namespace RR.UI.Editor.Animations
{
	[Obsolete("Use DoTween Pro instead")]
	...
	public class AnimationEditor : UnityEditor.Editor
	{
		...
		void OnEnable()
		{
			logo = Resources.Load<Texture2D>("RRUI_animation_icon");
			foldout = null;
		...
		public override void OnInspectorGUI()
		{
			...
			GUILayout.Space(30);
			GUI.DrawTexture(new Rect(Screen.width / 2 - 100, 2, 200, 26), logo, ScaleMode.StretchToFill, true);
