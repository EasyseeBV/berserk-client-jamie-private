...
{
	[CreateNodeMenu("AI/Custom/SelfCreaturesCount")]
	public class SelfCreaturesCountNode : BaseBehaviourNode
	{
		[SerializeField]
		private IntConditionNodeModel model;

		public override object Model => model;
		public override AiBehaviourNodeType NodeType => AiBehaviourNodeType.SelfCreaturesCount;
	}
}