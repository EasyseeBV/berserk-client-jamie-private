...
{
    public partial class GraveyardPileView : RR.UI.FrameSystem.BaseView //Autogenerated
    {
        public static UI.GraveyardPileView Instance { get; private set; }
        ...
        public UI.GraveyardPileView Build()
        {
            OnBuildSafe(true);
            return this;
        }
