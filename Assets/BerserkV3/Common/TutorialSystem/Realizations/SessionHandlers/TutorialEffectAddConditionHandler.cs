...
{
	public class TutorialEffectAddConditionHandler : ITutorialInvokeHandler, ITutorialOrderable, 
		ITutorialCloseHandler, ITutorialIdentity
	{
		...
		{
			TutorialTrigger.EffectAdd.ToString()
		};

		public TutorialEffectAddConditionHandler(
		...
		public Task InvokeAsync(ITutorialHintEntity hint)
		{
			...
			logicEventsSource.Subscribe<AddObjectEffect>(EffectAdded, invokeSource.Token);

			void EffectAdded(AddObjectEffect data)
			{
