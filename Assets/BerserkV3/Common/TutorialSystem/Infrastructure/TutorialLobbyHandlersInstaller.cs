...
using BerserkV3.Common.TutorialSystem.LobbyHandlers;
...
namespace BerserkV3.Common.TutorialSystem
{
    public class TutorialLobbyHandlersInstaller : IDisposable
    {
            ...
            ITutorialHandlersRepository handlersRepository)
        {
            ...
            {
                instantiator.Instantiate<TutorialRestartHandler>(),
                instantiator.Instantiate<TutorialDeckEditExitHandler>(),
                instantiator.Instantiate<TutorialDuelsMenuExitHandler>(),
                instantiator.Instantiate<TutorialFirstVulcaniteHandler>(),
                instantiator.Instantiate<TutorialEndHandler>(),
            };
