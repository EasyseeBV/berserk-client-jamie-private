...
{
	[EffectCondition(EffectConditionType.CompareRound)]
	public class ConditionRound : EffectConditionBase
	{
		public override bool Eval(params object[] args)
		{
			...
			{
				CompareOp.None => true,
				CompareOp.Less => GameContext.Timer.RuntimeData.Round < value,
				CompareOp.More => GameContext.Timer.RuntimeData.Round > value,
				CompareOp.Equal => GameContext.Timer.RuntimeData.Round == value,
				CompareOp.LessOrEqual => GameContext.Timer.RuntimeData.Round <= value,
				CompareOp.MoreOrEqual => GameContext.Timer.RuntimeData.Round >= value,
